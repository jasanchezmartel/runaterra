    ...
    return (
        <>
            ...
            <div className="paragraph-container" id="paragraph-container">
                ...
                <p className="paragraph-p">1º En el caso de que una región no tenga suficientes campeones para completar lo que haga falta, se vuelve a aleatorizar tirara de región.</p><br></br>
